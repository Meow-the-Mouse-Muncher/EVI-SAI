...
if __name__ == '__main__':
    ...
    parser.add_argument("--valGT", type=str, default="/mnt/home_ssd/sjy/EF-SAI/EF_Dataset/test/Aps", help="validation aps path")
    parser.add_argument("--valEvent", type=str, default="/home_ssd/sjy/EF-SAI/EF_Dataset/test/Event/", help="validation event path")
    parser.add_argument("--valFrame", type=str, default="/home_ssd/sjy/EF-SAI/EF_Dataset/test/Frame/",help="validation frame path")
    parser.add_argument("--valEframe", type=str, default="/home_ssd/sjy/EF-SAI/EF_Dataset/test/Eframe/",
